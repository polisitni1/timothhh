document.addEventListener('DOMContentLoaded', function () {
    ...
    new Typed('.greeting', {
        strings: ["Hello", " Hai, hari ini aku sangat senang karena kamu mengunjungi websiteku, Ummm.. bolehkah aku tau namamu ? "],
        typeSpeed: 50,
        onComplete: () => {
            _('form').fade('in', 500);
        }
    ...
    formInputName.addEventListener('submit', function (e) {
        ...
        setTimeout(() => {
            ...
            new Typed('.apologize-text', {
                strings: ["Hello", "Hai " + name + ".. ^1000 sebelumnya maaf kalau aku terlalu berani untuk mengatakan ini, tapi kamu harus tau, kalau aku tidak bisa berlama-lama menyembunyikannya"],
                typeSpeed: 50,
                onComplete: () => {
